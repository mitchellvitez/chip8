...
static KEYS: &[Key] = &[
    Key {
        ...
        big_sprite: Some([0x3C, 0x7E, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0x7E, 0x3C]),
    },
    Key {
        key: 0x1,
        keycode: KeyCode::Digit1,
        sprite: [0x20, 0x60, 0x20, 0x20, 0x70],
        big_sprite: Some([0x18, 0x38, 0x58, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C]),
    },
    Key {
        key: 0x2,
        keycode: KeyCode::Digit2,
        sprite: [0xF0, 0x10, 0xF0, 0x80, 0xF0],
        big_sprite: Some([0x3E, 0x7F, 0xC3, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x7F, 0xFF]),
    },
    Key {
        key: 0x3,
        keycode: KeyCode::Digit3,
        sprite: [0xF0, 0x10, 0xF0, 0x10, 0xF0],
        big_sprite: Some([0x3C, 0x7E, 0xC3, 0x03, 0x0E, 0x0E, 0x03, 0xC3, 0x7E, 0x3C]),
    },
    Key {
        key: 0x4,
        keycode: KeyCode::KeyQ,
        sprite: [0x90, 0x90, 0xF0, 0x10, 0x10],
        big_sprite: Some([0x06, 0x0E, 0x1E, 0x36, 0x66, 0xC6, 0xFF, 0xFF, 0x06, 0x06]),
    },
    Key {
        key: 0x5,
        keycode: KeyCode::KeyW,
        sprite: [0xF0, 0x80, 0xF0, 0x10, 0xF0],
        big_sprite: Some([0xFF, 0xFF, 0xC0, 0xC0, 0xFC, 0xFE, 0x03, 0xC3, 0x7E, 0x3C]),
    },
    Key {
        key: 0x6,
        keycode: KeyCode::KeyE,
        sprite: [0xF0, 0x80, 0xF0, 0x90, 0xF0],
        big_sprite: Some([0x3E, 0x7C, 0xC0, 0xC0, 0xFC, 0xFE, 0xC3, 0xC3, 0x7E, 0x3C]),
    },
    Key {
        key: 0x7,
        keycode: KeyCode::KeyA,
        sprite: [0xF0, 0x10, 0x20, 0x40, 0x40],
        big_sprite: Some([0xFF, 0xFF, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x60, 0x60]),
    },
    Key {
        key: 0x8,
        keycode: KeyCode::KeyS,
        sprite: [0xF0, 0x90, 0xF0, 0x90, 0xF0],
        big_sprite: Some([0x3C, 0x7E, 0xC3, 0xC3, 0x7E, 0x7E, 0xC3, 0xC3, 0x7E, 0x3C]),
    },
    Key {
        key: 0x9,
        keycode: KeyCode::KeyD,
        sprite: [0xF0, 0x90, 0xF0, 0x10, 0xF0],
        big_sprite: Some([0x3C, 0x7E, 0xC3, 0xC3, 0x7F, 0x3F, 0x03, 0x03, 0x3E, 0x7C]),
    },
    Key {
        key: 0xA,
...
pub fn key_big_sprite(key: u8) -> Option<[u8; 10]> {
    KEYS.iter()
        .find(|k| k.key == key)
